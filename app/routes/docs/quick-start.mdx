...
<br/>
  ...
  -  Handle submit - When you want to handle submit, you need to manage the submit event, it's really convenient when you have an already solution to do that.
